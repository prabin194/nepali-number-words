...
describe("amountToNepaliWords options", () => {
  describe("chequeStyle option", () => {
    ...
    it("should handle zero with cheque style", () => {
      expect(amountToNepaliWords(0, { chequeStyle: true })).toBe(
        "शून्य  रुपैयाँ  मात्र"
      );
    });
  });
